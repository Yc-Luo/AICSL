        ...
        <div className="space-y-8 animate-fadeIn">
            ...
            {resources.length > 0 ? (
                    ...
                    <table className="w-full min-w-full">
                        <thead className="bg-gray-50/50">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-widest">分配项目</th>
                ...
                <div className="bg-white rounded-3xl border-2 border-dashed border-gray-100 p-20 text-center">
                    ...
                    <p className="text-gray-500 mt-2 font-medium max-w-xs mx-auto">点击右上角“上传资源”为指定探究项目分发学习资料或模板文档。</p>
                </div>
            )}
                ...
                <DialogContent className="max-w-md rounded-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-sm text-slate-500 mt-1">
                            上传文件并将其关联到指定的探究项目，该组成员将能即时查看并使用。
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="space-y-6 pt-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                {projects.length === 0 && <option disabled>暂无可选项目</option>}
                            </select>
                            <p className="text-[10px] text-slate-400 font-medium">资源需绑定到具体项目才能被该组成员查看。</p>
                        </div>
                    </div>
