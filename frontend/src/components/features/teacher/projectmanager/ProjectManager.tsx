...
export default function ProjectManager() {
    ...
    const handleDelete = async (id: string) => {
        if (!confirm('确定要删除这个项目吗？所有数据都将被清除。')) return;
        try {
    ...
    if (loading) {
        return <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-3 text-slate-500">加载项目中...</span>
        </div>;
    }
        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">创建、监控和管理学生的协作项目。</p>
                </div>
                <Button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    className="flex-1 gap-1.5"
                                    onClick={() => navigate(`/teacher/analytics?project=${project.id}`)}
                                >
                ...
                {filteredProjects.length === 0 && (
                    <div className="col-span-full py-20 bg-white rounded-xl border-2 border-dashed border-gray-100 flex flex-col items-center justify-center text-slate-500">
                        ...
                        <p className="text-lg">暂无符合条件的筛选项目</p>
                    </div>
                )}
            </div>
