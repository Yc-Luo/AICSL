...
export const ClaimNode = memo(({ data, selected }: NodeProps<InquiryNodeData>) => (
    <BaseNode
...
export const EvidenceNode = memo(({ data, selected }: NodeProps<InquiryNodeData>) => (
    <BaseNode
...
export const CounterNode = memo(({ data, selected }: NodeProps<InquiryNodeData>) => (
    <BaseNode
...
export const RebuttalNode = memo(({ data, selected }: NodeProps<InquiryNodeData>) => (
    <BaseNode
